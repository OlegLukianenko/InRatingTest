...
public class ActivitySplashBindingImpl extends ActivitySplashBinding  {
    ...
    private ActivitySplashBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        super(bindingComponent, root, 2
            ...
            , (inratind.test.application.databinding.LayoutSnackBarBinding) bindings[2]
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.view == variableId) {
            ...
            setViewModel((inratind.test.application.viewmodel.SplashActivityViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable inratind.test.application.viewmodel.SplashActivityViewModel ViewModel) {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeIncludeLayoutSnackBar((inratind.test.application.databinding.LayoutSnackBarBinding) object, fieldId);
            case 1 :
                return onChangeViewModelGetProgressBarEvent((android.arch.lifecycle.MutableLiveData<java.lang.Boolean>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeIncludeLayoutSnackBar(inratind.test.application.databinding.LayoutSnackBarBinding IncludeLayoutSnackBar, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        inratind.test.application.viewmodel.SplashActivityViewModel viewModel = mViewModel;
