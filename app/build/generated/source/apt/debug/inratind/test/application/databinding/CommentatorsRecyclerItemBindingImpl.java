...
public class CommentatorsRecyclerItemBindingImpl extends CommentatorsRecyclerItemBinding  {
    ...
    public CommentatorsRecyclerItemBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private CommentatorsRecyclerItemBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.data == variableId) {
            ...
            setAdapter((inratind.test.application.app.home.adapter.CommentatorsRecyclerAdapter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable inratind.test.application.app.home.adapter.CommentatorsRecyclerAdapter Adapter) {
