...
public class MentionsRecyclerItemBindingImpl extends MentionsRecyclerItemBinding  {
    ...
    public MentionsRecyclerItemBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private MentionsRecyclerItemBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.data == variableId) {
            ...
            setAdapter((inratind.test.application.app.home.adapter.MentionsRecyclerAdapter) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setAdapter(@Nullable inratind.test.application.app.home.adapter.MentionsRecyclerAdapter Adapter) {
