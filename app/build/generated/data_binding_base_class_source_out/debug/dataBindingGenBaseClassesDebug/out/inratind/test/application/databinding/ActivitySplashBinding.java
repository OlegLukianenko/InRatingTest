...
public abstract class ActivitySplashBinding extends ViewDataBinding {
  ...
  public static ActivitySplashBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<ActivitySplashBinding>inflate(inflater, inratind.test.application.R.layout.activity_splash, root, attachToRoot, component);
  }
  ...
  public static ActivitySplashBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<ActivitySplashBinding>inflate(inflater, inratind.test.application.R.layout.activity_splash, null, false, component);
  }
  ...
  public static ActivitySplashBinding bind(@NonNull View view,
      @Nullable DataBindingComponent component) {
    return (ActivitySplashBinding)bind(component, view, inratind.test.application.R.layout.activity_splash);
  }
}
