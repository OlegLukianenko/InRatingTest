...
public abstract class LayoutSnackBarBinding extends ViewDataBinding {
  ...
  public static LayoutSnackBarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<LayoutSnackBarBinding>inflate(inflater, inratind.test.application.R.layout.layout_snack_bar, root, attachToRoot, component);
  }
  ...
  public static LayoutSnackBarBinding inflate(@NonNull LayoutInflater inflater,
    ...
    return DataBindingUtil.<LayoutSnackBarBinding>inflate(inflater, inratind.test.application.R.layout.layout_snack_bar, null, false, component);
  }
  ...
  public static LayoutSnackBarBinding bind(@NonNull View view,
      @Nullable DataBindingComponent component) {
    return (LayoutSnackBarBinding)bind(component, view, inratind.test.application.R.layout.layout_snack_bar);
  }
}
